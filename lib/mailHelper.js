...
function IsRecetteMail($mailAddress) {
    let isProd = global.sails.config.connections.isProdDb;
    console.log("IsRecetteMail", $mailAddress, global.sails.config.connections.isProdDb, $mailAddress && $mailAddress.indexOf("recette_"));
    return !isProd && $mailAddress && $mailAddress.indexOf("recette_") === 0;
}
